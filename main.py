...
app = FastAPI(title="Tomasz Trading Journal v2.4 — R Metrics")
...
@app.get("/health")
def health():
    return {"ok": True, "version": "2.4", "entry_types": ["taken", "missed", "summary"], "trade_numbers": True, "r_metrics": True}
